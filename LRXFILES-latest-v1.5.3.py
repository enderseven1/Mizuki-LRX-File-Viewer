...
try:
    ...
    print('Yes.')
    print('依赖项全部齐全，启动（Modules are available, starting）...\n')
...
WHAT_S_NEW = {'中文':('感谢你更新到 v' + VERSION + ' 版本！以下是该版本的最新特性：\n'
                    '一、增加了参数模式。可以在程序目录下的cmd中运行并加参数：本程序 文件名 密码。\n例如：LRXFILES-latest-v1.5.3.py 3.2.lrx 1234567890'),
              'English':('Thank you for update to version ' + VERSION + '!\nWhat\'s new:\n'
                         '1. Added arguments mode. It can be run in cmd in path of the program and add arguments: program filename password. \n'
                         'For example: LRXFILES-latest-v1.5.3.py 3.2.lrx 1234567890')}
